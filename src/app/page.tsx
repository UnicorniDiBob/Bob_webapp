...
import { ProfessionalCardItem, BobDot } from "@/components/ui";
...
export default async function HomePage() {
  ...
  return (
    <>
        ...
        <div className="container-bob grid grid-cols-1 items-center gap-10 py-12 lg:grid-cols-2 lg:py-20">
          <div className="animate-fade-up">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-bob-ink/55">
              ...
              <span className="inline-flex items-center gap-1.5">
                <BobDot /> Niente lead a pagamento
              </span>
              <span className="inline-flex items-center gap-1.5">
                <BobDot /> Messaggio scritto da Bob
              </span>
            </div>
          </div>
      ...
      {/* 7. FAQ
          Rimossi in questa passata: la banda con i tre contatori (stampava
          quanto siamo piccoli: 1 città, pochi profili) e il blocco tratteggiato
          "Servizi premium in arrivo" (vendeva una cosa che non esiste). */}
      <section className="container-bob py-14">
